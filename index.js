...
controller.hears('marco', 'direct_message', function(bot, message) {
  ...
  //
  //     var randomNumber = Math.floor(Math.random() * (list.members.length - 0 + 1)) + 0;
  //
  //     var randomName = list.members[randomNumber].real_name;
  //
  //     console.log(list.members[randomNumber].real_name);
  //
  //     if (randomName == null || randomName == "" || randomName == undefined) {
  //       console.log('user has been deleted');
  //     } else {
